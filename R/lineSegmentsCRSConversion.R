...
# x x coordinate of the center of the line segment
# y y coordinate of the center of the line segment
# a object of class \link[circular]{circular} (circular package).It is the  of the line segment
